      ...
      <div className="flex-1 bg-white p-6 flex flex-col justify-between">
        <div className="flex-1">
          <div className="flex justify-between items-center">
            <div className="flex items-center mt-2">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs font-medium text-gray-500 group-hover:text-gray-700">asdfs</p>
              </div>
            </div>
          ...
          <div className="block mt-2">
            <p className="text-xl font-semibold text-gray-900">ewerw</p>
            <p className="mt-3 mb-3 text-base text-gray-500">sdf</p>
          </div>
        </div>
